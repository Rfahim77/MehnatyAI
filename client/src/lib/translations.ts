  ...
  ar: {
    ...
    pathways: {
      ...
      future_plan: {
        ...
        description: "خطة مهنية لمدة 3-6 أشهر مع تحليلات سوق العمل"
      },
      tailor_to_job: {
        title: "مواءمة السيرة الذاتية للوظيفة",
        description: "قارن سيرتك الذاتية بمتطلبات الوظيفة واحصل على توصيات لتحسينها"
      },
      interview: {
